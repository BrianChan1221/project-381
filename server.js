...
app.get('/api/library/:bookname', async (req,res) => { //async programming way
	if (req.params.bookname) {
		console.log(req.body)
        let criteria = {};
...
/*  UPDATE
curl -X PUT -H "Content-Type: application/json" --data '{"author":"abcd"}' project-381-9h99.onrender.com/api/library/jojojo

curl -X PUT -F "author=99999999" project-381-9h99.onrender.com/api/library/jojojo
*/
...
/*  DELETE
curl -X DELETE project-381-9h99.onrender.com/api/library/jojojo
*/
